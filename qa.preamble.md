...
**Name:** _ومن أحياها — Waman Ahyaha Donation Tracker_
...
_Originally generated by `qapture init`; hand-tailored for Waman Ahyaha from the repo's route/view map (`js/app.js`, `js/auth.js`, `js/data.js`, `index.html`, `backend/routes/*`). See https://github.com/mohammed-farhood/qapture for docs._
